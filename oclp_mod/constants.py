...
class Constants:
    def __init__(self) -> None:
        ...
        self.mousse_version:     str = "0.95-laobamac"  # MouSSE
        ...
        self.macos12_disable_kdk:     bool = False
        self.macos15_disable_ml:     bool = False
    ...
    def overlay_psp_path_dmg(self):
        return self.original_path / Path("laobamacInternalResources.dmg")
    ...
    def oclp_helper_path(self):
        return self.payload_path / Path("Tools/OCLP-Mod.app/Contents/MacOS/OCLP-Mod")
