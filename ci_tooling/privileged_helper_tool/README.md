...
`com.pyquick.oclp-mod.privileged-helper` is OCLP-Mod's Privileged Helper Tool.
...
Since running OCLP-Mod from source will lack pyquick's code signature, you will need to disable code signature verification in the privileged helper tool otherwise root commands will fail.
